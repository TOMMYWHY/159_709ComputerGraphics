...
//            sphereIndices.push_back((i + 1) * (X_SEGMENTS + 1) + j + 1);
            sphereIndices.push_back(glm::ivec3(i * (X_SEGMENTS+1) + j, (i + 1) * (X_SEGMENTS + 1) + j, (i + 1) * (X_SEGMENTS + 1) + j + 1 ));

            sphereIndices.push_back(glm::ivec3(i * (X_SEGMENTS + 1) + j, (i + 1) * (X_SEGMENTS + 1) + j + 1, i * (X_SEGMENTS + 1) + j + 1 ));
...
//            sphereIndices.push_back(i * (X_SEGMENTS + 1) + j + 1);
    ...
    {
        std::cout<<sphereVertices[i]<<"," << std::endl;
    }*/
...
//    glBufferData(GL_ARRAY_BUFFER, sphereVertices.size() * sizeof(float), &sphereVertices[0], GL_STATIC_DRAW);
    glBufferData(GL_ARRAY_BUFFER, sphereVertices.size() * sizeof(glm::vec4),  sphereVertices.data(), GL_STATIC_DRAW);
...
//    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sphereIndices.size() * sizeof(int), &sphereIndices[0], GL_STATIC_DRAW);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sphereIndices.size() * sizeof(glm::ivec3), sphereIndices.data(), GL_STATIC_DRAW);
