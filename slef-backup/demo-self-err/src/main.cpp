...
// Vertex and Index buffers (host)
   ...
   /* vector<GLuint> textureIDs;
    ...
    GLuint texture = loadTexture2D(stars[0].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture1 = loadTexture2D(stars[1].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture2 = loadTexture2D(stars[2].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture3 = loadTexture2D(stars[3].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture4 = loadTexture2D(stars[4].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture5 = loadTexture2D(stars[5].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture6 = loadTexture2D(stars[6].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
    GLuint texture7 = loadTexture2D(stars[7].url, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);
   /* const char * texture_url1 = "images/jupitermap.jpg";
    GLuint texture1 = loadTexture2D(texture_url1, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);

    const char * texture_url2 = "images/neptunemap.jpg";
    GLuint texture2= loadTexture2D(texture_url1, x, y, n, GL_LINEAR_MIPMAP_LINEAR,GL_LINEAR);*/
...
//    glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, 12 * sizeof(GLfloat), NULL);
 ...
 /*   GLuint textureMapLoc = glGetUniformLocation(sunProgram, "textureSun");
