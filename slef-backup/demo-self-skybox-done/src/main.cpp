...
STAR Mercury = {"./images/mercurymap.jpg",  .1f,    2.5f,   1.4f,1.87f};
STAR Venus = {"./images/venusmap.jpg",      .3f,    3.5f,   1.3f,2.24f};
STAR Earth = {"./images/EarthMap.jpg",      .8f,    5.0f,   1.0f,3.65f};
STAR Mars = {"./images/mars_1k_color.jpg",  .4f,    7.5f,   0.8f,6.86f};
STAR Jupiter = {"./images/jupitermap.jpg",  2.5f,   9.0f,   0.4f,5.32f};
STAR Saturn = {"./images/saturnmap.jpg",    1.0f,   11.5f,   0.3f,40.0f};
STAR Uranus = {"./images/uranusmap.jpg",    0.8f,   14.0f,   0.2f,80.0f};
STAR Neptune = {"./images/neptunemap.jpg",  .8f,    16.5f,   0.1f,100.0f};
