...
uniform vec4 u_Light_position = vec4(0.0f, 1.0f, 0.0f, 0.0f);  //光源 位置
//uniform mat4 _Light_Direction_angle ;

uniform vec4 light_ambient = vec4(0.1f, 0.0f, 0.0f, 1.0f); // 环境光为0 显示材质本来颜色 light color
uniform vec4 light_diffuse = vec4(0.5f, 0.5f, 0.5f,1.0f);
...
uniform vec4 material_ambient = vec4(0.329412, 0.223529, 0.027451, 1.0);
uniform vec4 material_diffuse = vec4(0.780392, 0.568627, 0.113725, 1.0);
uniform vec4 material_specular = vec4(0.992157, 0.941176, 0.807843, 1.0);
