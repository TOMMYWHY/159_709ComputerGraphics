...
// --------------------------------------------------------------------------------
// Create Axis
void createAxes(std::vector<glm::vec4> &buffer, std::vector<glm::ivec2> &indexes) {
	// X - Axis
	buffer.push_back(glm::vec4(0, 0, 0, 1)); // Position
	buffer.push_back(glm::vec4(1, 0, 0, 0)); // Colour

	buffer.push_back(glm::vec4(6, 0, 0, 1)); // Position
	buffer.push_back(glm::vec4(1, 0, 0, 0)); // Colour

	indexes.push_back(glm::ivec2(0, 1)); // Indexes

	// Y - Axis
	buffer.push_back(glm::vec4(0, 0, 0, 1)); // Position
	buffer.push_back(glm::vec4(0, 1, 0, 0)); // Colour

	buffer.push_back(glm::vec4(0, 6, 0, 1)); // Position
	buffer.push_back(glm::vec4(0, 1, 0, 0)); // Colour

	indexes.push_back(glm::ivec2(2, 3)); // Indexes

	// Z - Axis
	buffer.push_back(glm::vec4(0, 0, 0, 1)); // Position
	buffer.push_back(glm::vec4(0, 0, 1, 0)); // Colour

	buffer.push_back(glm::vec4(0, 0, 6, 1)); // Position
	buffer.push_back(glm::vec4(0, 0, 1, 0)); // Colour

	indexes.push_back(glm::ivec2(4, 5)); // Indexes
}
...
// --------------------------------------------------------------------------------
// Create Brick with Positions and Normals
void createBrick(std::vector<glm::vec4> &buffer, std::vector<glm::ivec3> &indexes) {
	float x = 2.0f;
	float y = 1.0f;
	float z = 4.0f;
	...
	// ---- Top ----
	// Left-Top-Back - 0
	buffer.push_back(glm::vec4(   -x,     y,    -z,  1.0f));
